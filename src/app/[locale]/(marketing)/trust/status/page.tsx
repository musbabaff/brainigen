...
export const metadata = {
  title: 'System Status | Brainigen',
  description: 'Learn more about System Status with Brainigen.',
};

export default function SystemStatusPage({ params }: { params: Promise<{ locale: string }> }) {
