...
export const metadata = {
  title: 'Compliance | Brainigen',
  description: 'Learn more about Compliance with Brainigen.',
};

export default function CompliancePage({ params }: { params: Promise<{ locale: string }> }) {
