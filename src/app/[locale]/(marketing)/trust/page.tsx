...
export const metadata = {
  title: 'Trust Center | Brainigen',
  description: 'Learn more about Trust Center with Brainigen.',
};

export default function TrustCenterPage({ params }: { params: Promise<{ locale: string }> }) {
