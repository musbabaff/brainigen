...
export const metadata = {
  title: 'Quickstart | Brainigen',
  description: 'Learn more about Quickstart with Brainigen.',
};

export default function QuickstartPage({ params }: { params: Promise<{ locale: string }> }) {
