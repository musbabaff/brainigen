...
export const metadata = {
  title: 'Healthcare | Brainigen',
  description: 'Learn more about Healthcare with Brainigen.',
};

export default function HealthcarePage({ params }: { params: Promise<{ locale: string }> }) {
