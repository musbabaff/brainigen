...
export const metadata = {
  title: 'E-Commerce | Brainigen',
  description: 'Learn more about E-Commerce with Brainigen.',
};

export default function ECommercePage({ params }: { params: Promise<{ locale: string }> }) {
