...
export const metadata = {
  title: 'Customer Support | Brainigen',
  description: 'Learn more about Customer Support with Brainigen.',
};

export default function CustomerSupportPage({ params }: { params: Promise<{ locale: string }> }) {
