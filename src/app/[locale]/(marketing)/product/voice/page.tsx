...
export const metadata = {
  title: 'Voice Agents | Brainigen',
  description: 'Learn more about Voice Agents with Brainigen.',
};

export default function VoiceAgentsPage({ params }: { params: Promise<{ locale: string }> }) {
