...
export const metadata = {
  title: 'Knowledge Base | Brainigen',
  description: 'Learn more about Knowledge Base with Brainigen.',
};

export default function KnowledgeBasePage({ params }: { params: Promise<{ locale: string }> }) {
