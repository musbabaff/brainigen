...
export const metadata = {
  title: 'Product Overview | Brainigen',
  description: 'Learn more about Product Overview with Brainigen.',
};

export default function ProductOverviewPage({ params }: { params: Promise<{ locale: string }> }) {
