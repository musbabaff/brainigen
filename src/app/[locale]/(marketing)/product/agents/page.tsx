...
export const metadata = {
  title: 'AI Agents | Brainigen',
  description: 'Learn more about AI Agents with Brainigen.',
};

export default function AIAgentsPage({ params }: { params: Promise<{ locale: string }> }) {
