...
export const metadata = {
  title: 'Case Studies | Brainigen',
  description: 'Learn more about Case Studies with Brainigen.',
};

export default function CaseStudiesPage({ params }: { params: Promise<{ locale: string }> }) {
