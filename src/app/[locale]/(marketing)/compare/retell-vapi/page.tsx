...
export const metadata = {
  title: 'vs Retell & Vapi | Brainigen',
  description: 'Learn more about vs Retell & Vapi with Brainigen.',
};

export default function vsRetellVapiPage({ params }: { params: Promise<{ locale: string }> }) {
