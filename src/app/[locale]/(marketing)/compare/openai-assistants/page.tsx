...
export const metadata = {
  title: 'vs OpenAI | Brainigen',
  description: 'Learn more about vs OpenAI with Brainigen.',
};

export default function vsOpenAIPage({ params }: { params: Promise<{ locale: string }> }) {
