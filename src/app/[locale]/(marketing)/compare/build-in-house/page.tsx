...
export const metadata = {
  title: 'vs In-House | Brainigen',
  description: 'Learn more about vs In-House with Brainigen.',
};

export default function vsInHousePage({ params }: { params: Promise<{ locale: string }> }) {
