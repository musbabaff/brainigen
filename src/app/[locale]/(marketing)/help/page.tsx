...
export const metadata = {
  title: 'Help Center | Brainigen',
  description: 'Learn more about Help Center with Brainigen.',
};

export default function HelpCenterPage({ params }: { params: Promise<{ locale: string }> }) {
