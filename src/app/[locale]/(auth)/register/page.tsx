    ...
    >
      <Card className="border-border/30 bg-card/60 backdrop-blur-sm shadow-xl">
        <CardHeader className="text-center pb-2 pt-8 px-8">
          ...
          <h1 className="text-2xl font-bold tracking-[-0.02em]">{t("register_title")}</h1>
        ...
        <CardContent className="px-8 pb-8 pt-4">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-sm font-medium">{t("full_name")}</Label>
                    ...
                    {[0, 1, 2].map((level) => (
                      <div
                        ...
                        className={cn(
                          ...
                          level <= strength.score ? strength.color : "bg-border/30"
                        )}
                      />
                    ))}
                  </div>
                  <p className={cn("text-[11px] capitalize", strength.color.replace("bg-", "text-"))}>
                    {strength.label}
                  </p>
                </div>
              )}
          ...
          <div className="flex gap-3">
            <Button variant="outline" className="flex-1 h-10 border-border/40 cursor-pointer font-medium"
